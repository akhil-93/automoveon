...
if ($(this).scrollTop() > 240){  
	...
	$('.navbartwo').show();
	$('.main-menu').css({"text-align" : "left" , "padding-left" : "160px" });
	$('.navbartwo').css({"margin-right" : "130px"})
  }
  else{
    $('#sticky-header').removeClass("sticky");
	$('.navbartwo').hide();
	$('.main-menu').css("text-align", "center");
	$('.main-menu').css({"text-align" : "center" , "padding-left" : "0px" });
  }
}); 
...
------------------------------ */  
	  $( "#slider-range" ).slider({
	   ...
	   slide: function( event, ui ) {
		$( "#amount" ).val( "د.إ" + ui.values[ 0 ] + " - $" + ui.values[ 1 ] );
	   }
	  });
	  $( "#amount" ).val( "د.إ" + $( "#slider-range" ).slider( "values", 0 ) +
	   " - د.إ" + $( "#slider-range" ).slider( "values", 1 ) );  
